...
caption <- "Höhe der Winterverluste in Prozent (und 95\\%~CI) und Anzahl der Antworten in Abhängigkeit von der Seehöhe der Winterstandorte über die Umfragejahre 2017/18 - 2020/21. Nicht ausgewertet sind TeilnehmerInnen die „Nein“ oder „Unsicher“ oder „Ja“ bei Fragestellung „Alle Bienenvölker innerhalb eines 15 km Radius“ angaben, sowie ihre Bienenvölker in „mehr als einem Bezirk“ aufgestellt haben."
